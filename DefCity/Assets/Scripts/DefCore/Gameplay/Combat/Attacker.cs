...
// Todo: 추후 여유가 있을 때, Attacker의 이벤트의 Args를 통일하고 활성 공격과 공격 요청과 예약 기능까지 리팩토링 및 구현을 고려할 것.
...
namespace DefCore.Gameplay.Combat
{
    ...
    public readonly struct AttackInfoArgs
    {
        ...
        public AttackInfoArgs(int? attackId, Attacker attacker)
        {
            AttackId = attackId;
            Attacker = attacker;
            Weapon = null;
    ...
    public readonly struct AttackCooldownEndEventArgs
    {
        ...
        public AttackCooldownEndEventArgs(Attacker attacker, WeaponBase weapon) : this()
        {
            Attacker = attacker;
            Weapon = weapon;
