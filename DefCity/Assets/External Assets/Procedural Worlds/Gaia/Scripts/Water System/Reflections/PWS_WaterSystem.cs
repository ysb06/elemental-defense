    ...
    public class PWS_WaterSystem : MonoBehaviour
    {
        public static PWS_WaterSystem Instance
        {
            get 
            {
                if (m_instance == null)
                {
                    m_instance = GaiaUtils.FindOOT<PWS_WaterSystem>();
                }
                return m_instance; 
            }
...
#region Build/Clear Reflections
        ...
        private void SetMassiveCloudSystem(Camera gameCamera, Camera reflectionCamera, bool cleanup = false)
        {
            if (cleanup)
            {
                MassiveCloudsCameraEffect[] massiveCloudComponentsCameras = GaiaUtils.FindOOTs<MassiveCloudsCameraEffect>();
                ...
                MassiveClouds[] massiveCloudComponentsMains = GaiaUtils.FindOOTs<MassiveClouds>();
...
#region URP
        ...
        {
            GaiaPlanarReflections planarReflections = GaiaUtils.FindOOT<GaiaPlanarReflections>();
