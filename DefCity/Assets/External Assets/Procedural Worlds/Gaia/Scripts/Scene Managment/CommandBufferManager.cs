...
namespace Gaia
{
    ...
    public class CommandBufferManager : MonoBehaviour
    {
        ...
        private void StartBuffers()
        {
            switch (RenderPipeline)
            {
                case GaiaConstants.EnvironmentRenderer.BuiltIn:
                    ...
                    break;
                default:
                    // Camera.AddCommandBuffer is built-in only.
                    break;
            }
        }
        /// <summary>
        ...
        private void RenderBuffers(Camera i_cam)
        {
            ...
            // AddCommandBuffer / RemoveCommandBuffer are built-in renderer only APIs.
        ...
        {
            //Create Manager
            CommandBufferManager manager = GaiaUtils.FindOOT<CommandBufferManager>();
            if (manager == null)
            {
