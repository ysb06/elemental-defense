	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord32 = input.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord40 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord40 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 texCoord44 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 uv_MetallicGlossMap2 = input.ase_texcoord7.xy * _MetallicGlossMap2_ST.xy + _MetallicGlossMap2_ST.zw;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 texCoord32 = input.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode30 = tex2D( _Mask, texCoord32 );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color ) , ( tex2D( _Albedo, uv_Albedo ) * _Color0 ) , tex2DNode30.g);
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 texCoord32 = input.ase_texcoord1.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode30 = tex2D( _Mask, texCoord32 );
				float4 lerpResult16 = lerp( ( tex2DNode1 * _Color ) , ( tex2D( _Albedo, uv_Albedo ) * _Color0 ) , tex2DNode30.g);
