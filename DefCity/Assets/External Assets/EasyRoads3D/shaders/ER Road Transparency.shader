	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord23 = input.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 Emission = 0;
				float Alpha = ( ( tex2DNode1.a * _Color.a ) * input.ase_color.a );
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				surfaceDescription.Alpha = ( ( tex2DNode1.a * _Color.a ) * input.ase_color.a );
