	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord22 = input.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord37 = input.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord22 = input.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_Target
			{
				...
				float2 uv_MainTex = input.ase_texcoord1.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 tex2DNode1 = tex2D( _MainTex, uv_MainTex );
				float2 texCoord22 = input.ase_texcoord1.zw * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				float3 unpack5 = UnpackNormalScale( tex2D( _BumpMap, texCoord26 ), _BumpScale );
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 texCoord37 = input.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float3 unpack36 = UnpackNormalScale( tex2D( _DetailNormalMap, texCoord37 ), _DetailNormalMapScale );
				unpack36.z = lerp( 1, unpack36.z, saturate(_DetailNormalMapScale) );
