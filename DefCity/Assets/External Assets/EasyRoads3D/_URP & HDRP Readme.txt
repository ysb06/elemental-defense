...
After the EasyRoads3D Pro package is imported, scripts run that will automatically import the required material package unless there are timeout warnings when updating the assemblies after package import.
